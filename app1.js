  ...
  return (
    ...
    <div className="App">
      ...
      <header className="App-header">
        ...
        <form >
          <select name="Valoda" id="language" >
        ...
        <form onSubmit={(e) => {
          e.preventDefault()
            ...
            axios.post('http://localhost:3004/japanese', {kanji: newWord.kanji, onyomi: newWord.onyomi, kunyomi: newWord.kunyomi, latValTulk: newWord.latValTulk})
            .then(() => {
            fetchAllWords()
